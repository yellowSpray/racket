...
const { mockSupabase } = vi.hoisted(() => {
    const qb: any = {
        ...
        maybeSingle: vi.fn().mockReturnThis(), limit: vi.fn().mockReturnThis(), lt: vi.fn().mockReturnThis(),
        neq: vi.fn().mockReturnThis(), then: vi.fn(),
    ...
    return { mockSupabase: { from: vi.fn((_table?: string) => qb), _builder: qb } }
})
